...
/**
 * Subclass of {@link org.springframework.web.client.DefaultResponseErrorHandler} that handles errors from VKontakte's
 * API, interpreting them into appropriate exceptions.
 *
 * @author vkolodrevskiy
 */
public class VKErrorHandler extends DefaultResponseErrorHandler {
    @Override
