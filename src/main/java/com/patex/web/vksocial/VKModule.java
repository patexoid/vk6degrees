 ...
 */
public class VKModule extends SimpleModule {
    ...
    public void setupModule(SetupContext context) {
        context.setMixInAnnotations(VKProfile.class, VKProfileMixin.class);
        context.setMixInAnnotations(VKProfiles.class, VKProfilesMixin.class);
